...
TEST_LEGACY_PAYLOADS = [
    {'stream': "00000067000001000100000000000003e90000007b000000000000000000000000",
     'result': {'version': 0, 'short_channel_id': '103x3x1', 'amt_to_forward': 1000, 'outgoing_cltv_value': 117, 'padding': '000000000000000000000000'}
    },
...
if __name__ == "__main__":
    ...
    for test in TEST_LEGACY_PAYLOADS:
        parsed, err = Payload.parse(h2b(test['stream']))
        print(parsed)
        #print(err)
    ...
    for test in TEST_TLV_PAYLOADS:
        parsed, err = Payload.parse(h2b(test))
        print(parsed)
        print(err)
